...
func TestWriteDDL(t *testing.T) {
	...
	rows := []writer.RedoEvent{
		nil,
		&model.RowChangedEvent{PhysicalTableID: 11, CommitTs: 11, TableInfo: &model.TableInfo{}},
		&model.RowChangedEvent{PhysicalTableID: 12, CommitTs: 15, TableInfo: &model.TableInfo{}},
		&model.RowChangedEvent{PhysicalTableID: 12, CommitTs: 8, TableInfo: &model.TableInfo{}},
	}
