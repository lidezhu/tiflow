	...
	events := []mqEvent{
		{
			rowEvent: &dmlsink.RowChangeCallbackableEvent{
				Event: &model.RowChangedEvent{
					...
					Columns:   model.Columns2ColumnDatas([]*model.Column{{Name: "col1", Type: 1, Value: "aa"}}, tableInfo1),
				},
				Callback:  func() {},
				SinkState: &tableStatus,
			},
	...
	events := []mqEvent{
		{
			rowEvent: &dmlsink.RowChangeCallbackableEvent{
				Event: &model.RowChangedEvent{
					CommitTs:  1,
					TableInfo: tableInfo,
					Columns:   model.Columns2ColumnDatas([]*model.Column{{Name: "col1", Value: "aa"}}, tableInfo),
				},
				Callback:  func() {},
		...
		},
		{
			rowEvent: &dmlsink.RowChangeCallbackableEvent{
				Event: &model.RowChangedEvent{
					CommitTs:  3,
					TableInfo: tableInfo,
					Columns:   model.Columns2ColumnDatas([]*model.Column{{Name: "col1", Value: "bb"}}, tableInfo),
				},
				Callback:  func() {},
				SinkState: &tableStatus,
			},
